...
global $product;
?>
<div <?php warp_add_class('html.div', ['append' => "woocommerce-variation-add-to-cart, variations_button" ]) ?>>
	...
	<input <?php warp_add_class('html.input', ['append' => "variation_id" ]) ?> type="hidden" name="variation_id" value="0" />
</div>
